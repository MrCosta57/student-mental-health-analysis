...
metrics_val_lda <- k_fold_cv(
  ...
  n_fold = num_k_fold, is_generative = TRUE, seed = seed
)
...
metrics_val_nb <- k_fold_cv(
  ...
  n_fold = num_k_fold, is_nb = TRUE, seed = seed
)
...
metrics_val_gam_bic <- k_fold_cv(
  ...
  n_fold = num_k_fold, seed = seed, family = "binomial"
)
