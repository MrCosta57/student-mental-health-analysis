...
- In general the students with high severity in symptoms are fortunately extremely low so symptoms distribution is right skewed
...
Just for the grade *Freshmen* the number of positive suicide in higher than the other levels, and in particular there are less suicide for lower grading.

Grade variable it's possibly related to some age information that in the dataframe is not present. 
...
The histograms of the symptoms features instead show a slightly different behavior.
