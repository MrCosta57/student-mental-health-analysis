...
The coefficients in this case represent the log-odds increment/decrement of the outcome (suicide) for a one-unit increase in the predictor variable, holding all other variables constant. A positive coefficient indicates an increase in the log-odds of suicide, while a negative coefficient indicates a decrease.
...
model 2 contains some possible varaible that apperar more discriminative and influential
